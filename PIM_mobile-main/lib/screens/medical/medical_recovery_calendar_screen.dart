                      ...
                      child: TableCalendar<_ReturnEntry>(
                        ...
                        calendarStyle: CalendarStyle(
                          todayDecoration: BoxDecoration(
                            color: MedicalTheme.accentBlue.withOpacity(0.18),
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(color: MedicalTheme.cardBorder.withOpacity(0.7)),
      ),
      child: Row(
        mainAxisSize: MainAxisSize.min,
        children: [
    ...
    return AppCard(
      child: Row(
        children: [
          ...
          Icon(Icons.health_and_safety, color: MedicalTheme.accentBlue),
