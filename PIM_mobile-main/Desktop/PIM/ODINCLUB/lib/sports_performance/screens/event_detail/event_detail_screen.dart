...
class _EventDetailScreenState extends ConsumerState<EventDetailScreen> {
          ...
          ElevatedButton(
            onPressed: () async {
              ...
              if (result && mounted) {
                ...
                Navigator.pop(context); // Back to calendar
              } else if (mounted) {
                ScaffoldMessenger.of(context).showSnackBar(
                  const SnackBar(
  ...
  void _confirmCloseEvent(BuildContext context) {
    showDialog(
      context: context,
      builder: (context) => AlertDialog(
        backgroundColor: SPColors.backgroundSecondary,
        ...
        content: const Text(
          'Voulez-vous vraiment clôturer ce suivi ? Vous pourrez générer les rapports après la clôture.',
          style: TextStyle(color: SPColors.textSecondary),
        ),
        actions: [
          TextButton(
