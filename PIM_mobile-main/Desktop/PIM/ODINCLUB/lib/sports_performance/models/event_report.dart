...
class ReportStatistics {
  ...
  factory ReportStatistics.fromJson(Map<String, dynamic> json) {
    final distribution = json['distribution'] ?? json;
    ...
    return ReportStatistics(
      averageScore: (distribution['averageScore'] ?? 0).toDouble(),
      medianScore: (distribution['medianScore'] ?? 0).toDouble(),
      standardDeviation: (distribution['standardDeviation'] ?? 0).toDouble(),
      minScore: (distribution['minScore'] ?? 0).toDouble(),
      maxScore: (distribution['maxScore'] ?? 0).toDouble(),
