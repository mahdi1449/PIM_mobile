              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    ElevatedButton(
                      onPressed: () =>
                          provider.fetchProfile(widget.playerId ?? ''),
  ...
  Widget _buildChallengesTab() {
    return ListView(
      ...
      children: [
        _challengeCard(
          '🧠 Expert Cognitif',
          'Compléter 5 tests cette semaine',
          0.6,
          '3/5',
          50,
          Colors.blueAccent,
        ...
        _challengeCard(
          '⚽ Assiduité',
          'Présence à tous les entraînements',
          1.0,
          'Terminé',
          100,
          Colors.greenAccent,
        ...
        _challengeCard(
          '🥗 Nutrition Top',
          'Loguer ses repas pendant 7 jours',
          0.2,
          '1/7',
          30,
          Colors.orangeAccent,
        ...
        _challengeCard(
          '⚡ Récupération',
          'Dormir 8h pendant 3 nuits consécutives',
          0.0,
          '0/3',
          40,
          Colors.purpleAccent,
          ...
          Row(
            children: [
                ...
                child: ClipRRect(
                  ...
                  child: LinearProgressIndicator(
                    ...
                    valueColor: AlwaysStoppedAnimation<Color>(
                      isCompleted ? accentColor : Colors.purpleAccent,
                    ),
                  ),
                ),
              ),
              ...
              Text(
                label,
                style: TextStyle(
                  color: isCompleted ? accentColor : Colors.white70,
                  fontSize: 12,
                  fontWeight: FontWeight.bold,
                ),
              ),
    ...
    return ListView(
      ...
      children: [
        _alertTile(
          ...
          'Vous avez obtenu le badge "Cerveau d\'Acier"',
          'IL Y A 2H',
        ...
        _alertTile(
          'Nouveau Défi',
          'Le coach a lancé un défi hebdomadaire',
          'IL Y A 2J',
          Icons.flag_outlined,
          Colors.purpleAccent,
        ),
